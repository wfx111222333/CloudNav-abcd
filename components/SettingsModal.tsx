                    ...
                    <div className="space-y-6 animate-in fade-in duration-300">
                        <div className="space-y-4">
                            ...
                            <div className="pt-4 border-t border-slate-100 dark:border-slate-700">
                                <h4 className="text-sm font-semibold mb-4 dark:text-slate-200">标题样式配置</h4>
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">标题颜色</label>
                                        <div className="flex items-center gap-2">
                                            <input
                                                type="color"
                                                value={localSiteSettings.titleColor || '#1e293b'}
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">标题大小</label>
                                        <div className="flex items-center gap-3">
                                            <input
                                                type="range"
                                                min="12"
                                                max="24"
                                                value={localSiteSettings.titleSize ?? 14}
                                                onChange={(e) => handleSiteChange('titleSize', parseInt(e.target.value))}
                                                className="flex-1 accent-blue-500"
                                            />
                                            <span className="text-sm text-slate-600 dark:text-slate-400 w-12 text-right">{localSiteSettings.titleSize ?? 14}px</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="mt-3 p-3 bg-slate-50 dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700">
                                    <p className="text-xs text-slate-500 dark:text-slate-400 text-center">
                                        预览：<span 
                                          ...
                                          style={{ 
                                            color: localSiteSettings.titleColor || '#1e293b',
                                            fontSize: `${localSiteSettings.titleSize || 14}px`
                                          }}
                                        >网站标题示例</span>
                                    </p>
                                </div>
                            ...
                            <div className="pt-4 border-t border-slate-100 dark:border-slate-700">
                                <h4 className="text-sm font-semibold mb-4 dark:text-slate-200">背景设置</h4>
                                <div>
                                    <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">背景颜色</label>
                                    <div className="flex items-center gap-2">
                                        <input
                                            type="color"
                                            value={localSiteSettings.backgroundColor || '#f8fafc'}
                                            onChange={(e) => handleSiteChange('backgroundColor', e.target.value)}
                                            className="w-10 h-10 rounded-lg border border-slate-300 dark:border-slate-600 cursor-pointer"
                                        />
                                        <input
                                            type="text"
                                            value={localSiteSettings.backgroundColor || ''}
                                            onChange={(e) => handleSiteChange('backgroundColor', e.target.value)}
                                            className="flex-1 p-2 rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white outline-none focus:ring-2 focus:ring-blue-500"
                                            placeholder="#f8fafc"
                                        />
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (file) {
                                                    ...
                                                    reader.onload = (event) => {
                                                        handleSiteChange('backgroundImage', event.target?.result as string);
                                                    };
                                                    reader.readAsDataURL(file);
                                                }
                                            }}
                                            className="w-full p-2 border border-dashed border-slate-300 dark:border-slate-600 rounded-lg cursor-pointer"
                                        />
                                        {localSiteSettings.backgroundImage && (
                                            <div className="mt-2">
                                                <img 
                                                  ...
                                                  alt="背景预览"
                                                  className="max-h-32 w-full object-cover rounded-lg border border-slate-200 dark:border-slate-700"
                                                />
                                                <button
                                                  onClick={() => handleSiteChange('backgroundImage', '')}
                            ...
                            <div className="pt-4 border-t border-slate-100 dark:border-slate-700">
                                <h4 className="text-sm font-semibold mb-4 dark:text-slate-200">卡片布局</h4>
                                <div>
                                    <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">每行显示卡片数量</label>
                                    <div className="flex gap-2">
                                        {[3, 4, 5, 6].map(num => (
                                            <button
                                                key={num}
                                                onClick={() => handleSiteChange('cardsPerRow', num)}
                                                className={`flex-1 py-2 rounded-lg border transition-colors ${
                                                    localSiteSettings.cardsPerRow === num
                                    ...
                                    <p className="text-xs text-slate-500 mt-2">调整每行显示的网站卡片数量，布局会自动适应不同屏幕尺寸</p>
                                </div>
                            </div>
                        </div>
                    </div>
